...
@section('title','GalkaShop || HOME PAGE')
@section('main-content')
<!-- Slider Area -->
@if(count($banners)>0)
<section id="Gslider" class="carousel slide" data-ride="carousel" data-interval="9000">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
            @php
                $isVideo = Str::endsWith($banner->photo, '.mp4');
            @endphp

            @if($isVideo)
                <video class="first-slide w-100" autoplay muted loop playsinline>
                    <source src="{{ asset($banner->photo) }}" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
            @else
                <img class="first-slide w-100" src="{{ asset($banner->photo) }}" alt="Banner image">
            @endif
